        ...
        <div class="col-md-5">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group row mb-3">
                    <label for="name" class="col-md-5 col-form-label fw-medium">氏名<span class="ms-1 samuraimart-require-input-label"><span class="samuraimart-require-input-label-text">必須</span></span></label>
                    <div class="col-md-7">
                        ...
                        @error('name')
                            <span class="invalid-feedback" role="alert"><strong>氏名を入力してください</strong></span>
                        @enderror
                    </div>
                </div>
                ...
                {{-- 郵便番号 --}}
                <div class="form-group row mb-3">
                    <label for="postal_code" class="col-md-5 col-form-label fw-medium">郵便番号<span class="ms-1 samuraimart-require-input-label"><span class="samuraimart-require-input-label-text">必須</span></span></label>
                    <div class="col-md-7">
                        ...
                        @error('postal_code')
                            <span class="invalid-feedback" role="alert"><strong>郵便番号を入力してください</strong></span>
                        @enderror
                    </div>
                </div>
                ...
                {{-- 住所 --}}
                <div class="form-group row mb-3">
                    <label for="address" class="col-md-5 col-form-label fw-medium">住所<span class="ms-1 samuraimart-require-input-label"><span class="samuraimart-require-input-label-text">必須</span></span></label>
                    <div class="col-md-7">
                        ...
                        @error('address')
                            <span class="invalid-feedback" role="alert"><strong>住所を入力してください</strong></span>
                        @enderror
                    </div>
                </div>
                ...
                {{-- 電話番号 --}}
                <div class="form-group row mb-3">
                    <label for="phone" class="col-md-5 col-form-label fw-medium">電話番号<span class="ms-1 samuraimart-require-input-label"><span class="samuraimart-require-input-label-text">必須</span></span></label>
                    <div class="col-md-7">
                        ...
                        @error('phone')
                            <span class="invalid-feedback" role="alert"><strong>電話番号を入力してください</strong></span>
                        @enderror
                    </div>
                </div>
                ...
                {{-- パスワード --}}
                <div class="form-group row mb-3">
                    <label for="password" class="col-md-5 col-form-label fw-medium">パスワード<span class="ms-1 samuraimart-require-input-label"><span class="samuraimart-require-input-label-text">必須</span></span></label>
                    <div class="col-md-7">
                ...
                <div class="form-group row mb-4">
                    <label for="password-confirm" class="col-md-5 col-form-label fw-medium">パスワード（確認用）<span class="ms-1 samuraimart-require-input-label"><span class="samuraimart-require-input-label-text">必須</span></span></label>
                    <div class="col-md-7">
